...
if (isset($_GET['submitForm'])) {
  ...
  $start_time = mysqli_real_escape_string($connection , $_GET['start_time']);
  $end_time = mysqli_real_escape_string($connection , $_GET['end_time']);
  $task_id = mysqli_real_escape_string($connection , $_GET['task_id']);



  $query = "INSERT INTO tbl_connect_214(start_time , end_time , task_id , user_id) VALUES ('$start_time' , '$end_time' , '$task_id' , '$userId')";
  // echo $query;
...
if(!$result) {
        ...
        echo "<script>alert('Task Added succesfully!');document.location='home.php?Id=" . $_GET['Id'] . "&Name=" . $_GET['Name'] ."&type=" . $_GET['type'] ."'</script>";
...
<html lang = "en">
    ...
    <div class="container">
      ...
      <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="home.php?Id=<?php echo $_GET['Id']; ?>&Name=<?php echo $_GET['Name']?>&type=<?php echo $_GET['type']?>">Home</a></li>
          <li class="breadcrumb-item"><a href="connect-list.php?Id=<?php echo $_GET['Id']; ?>&Name=<?php echo $_GET['Name']?>&type=<?php echo $_GET['type']?>">My team</a></li>
 ...
 <div id="wrapper">  
  ...
  <p><input type="time" id="start_time" name="start_time" value=""></p>

  <label for="end_time">End time:</label>
  <p><input type="time" id="end_time" name="end_time" value=""></p>
  
  <div class="mb-3">
			<label for="which_task" class="form-label">Choose task:</label>
          <select class="form-select" id="task_selection" name="task_id" placeholder="" data-selected="" value=""> 
                <option value="1">Time of arrival</option>
                <option value="2">Lunch break</option> 
                <option value="3">Dinner break</option>
                <option value="4">Training session</option>
                <option value="5">Self-practice time</option>
                <option value="6">Left the base</option>
                <option value="7">Arrived home</option>
			    </select>
	</div>
  ...
  <button type="submit" class="btn btn-light" name="submitForm">Add task</button>
