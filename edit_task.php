...
$query = "SELECT * FROM tbl_connect_214 WHERE user_id = $userId AND id = $uniqueTaskId";
// echo $query;
...
if(isset($_POST['update'])) {
  ...
  $query = "UPDATE tbl_connect_214 SET start_time='$start_time' , end_time='$end_time' , task_id='$task_id' WHERE id = '$uniqueTaskId'";
  mysqli_query($connection , $query);
  // echo $query;
  
  echo "<script>alert('Changes made succesfully!');document.location='home.php?Id=" . $_GET['Id'] . "&Name=" . $_GET['Name'] ."&type=" . $_GET['type'] ."'</script>";
}  
...
<html lang = "en">
     ...
     <head>
        ...
        <script src="js/get_messeges.js"></script>
 ...
 <div id="wrapper">  
  ...
  <p><input type="time" id="start_time" name="start_time" value="<?php echo $start_time?>"></p>

  <label for="end_time">End time:</label>
  <p><input type="time" id="end_time" name="end_time" value="<?php echo $end_time?>"></p>
  
  <div class="mb-3">
			<label for="which_task" class="form-label">Choose task:</label>
          <select class="form-select" id="task_selection" name="task_id" placeholder="" data-selected="" value="<?php echo $task_id?>"> 
  ...
  <button type="submit" class="btn btn-light" name="update">Edit</button>
